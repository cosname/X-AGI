    ...
    photos: [
      {
        ...
        basename: 'goal-history-e15-2022-beijing-context-opening.png',
        alt: '视频会议画面中，一名发言者居中讲话，右侧排列着其他参会者窗口。',
        caption: '第十五届会议所有会场均可通过腾讯会议在线参与。',
        role: 'speaker',
        sourceImageIndex: 4,
  ...
  },
  {
    ...
    photos: [
      ...
      },
      {
        ...
        basename: 'goal-history-e17-2024-beijing-xagi-ifods-participation-international-forum.webp',
        alt: '一名发言者手持话筒站在蓝色数据科学国际论坛背景屏幕前，前景为就座听众。',
        caption: '7月21日的数据科学国际论坛主会场在中国人民大学举行致辞与报告。',
        role: 'speaker',
        sourceImageIndex: 5,
      ...
      },
      {
        ...
        basename: 'goal-history-e17-2024-beijing-xagi-ifods-distinctive-moment-registration.jpg',
        alt: '参会者俯身在签到表上填写信息，桌后会务人员旁摆放着证件与会议材料。',
        caption: '会务人员在会场签到处为参会者办理登记并发放材料。',
        role: 'community',
        sourceImageIndex: 85,
