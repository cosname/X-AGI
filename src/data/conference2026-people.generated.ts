...
export const conference2026PeopleSource = {
  ...
  "people": [
    ...
    },
    {
      ...
      "affiliation": "上海交通大学",
      "department": "自然科学研究院、数学科学学院",
      "bio": "张耀宇，上海交通大学长聘教轨副教授，2012年于上海交通大学致远学院获应用物理学学士学位及应用数学第二专业，2016年于上海交通大学数学科学学院获数学博士学位，2016年至2020年先后于纽约大学阿布扎比分校&库朗研究所、普林斯顿高等研究院从事博士后研究工作，2020年加入上海交通大学。他的研究领域聚焦深度学习的理论基础，代表性成果包括深度学习的凝聚现象与动力学态的相图分析、损失景观的嵌入原则、样本效率的乐观估计等。相关工作发表于JMLR、M3AS、SIMODS、NeurIPS、ICML等机器学习和应用数学权威期刊和会议，并合著出版《深度学习现象导论：从感知机到大模型》。",
