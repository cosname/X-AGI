...
export const conference2026 = {
  ...
  nameZhOfficial: '第19届交叉智能大会暨中国R会议',
  sloganZh: '交叉智能 计算未来',
  ...
  introduction: [
    '2026 X-AGI Conference（第19届交叉智能大会暨中国R会议）拟于2026年10月16日至18日在北京友谊宾馆举行。本届大会以“AI Conference for the neXt Generation” 为主题，邀请来自国内外高校、科研机构与产业界的优秀学者和专家，共同探讨下一代人工智能研究的前沿问题与发展方向。“X”代表未知、交叉与探索。本次会议设置多个专题论坛，涵盖AI4Math、AI4Science、脑机接口、预训练算法的新进展、AI Infra、Agent、Agentic后训练、LLM评测与基准、大语言模型基础、生成建模新范式与理论基础、扩散模型理论基础与推理算法、机器学习理论、AI+Finance等多个重要方向。',
