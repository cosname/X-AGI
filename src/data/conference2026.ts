...
export const conference2026 = {
  ...
  sponsors: [
    ...
    },
    {
      name: 'QuantVerse',
      intro: [
        '上海数启寰宇人工智能科技有限公司依托于母公司在金融场景技术应用的深厚积累，借助大数据、自然语言处理、机器学习、深度学习、强化学习等核心技术，将量化交易算法模型、自动化交易执行模块等研发成果运用到量化组合管理中。自2025年落地徐汇西岸以来，公司已入选徐汇重点人工智能企业名录，并累计取得11项软件著作权。为持续提升算力基础设施与金融垂类模型迭代能力，年度研发投入超亿元。公司采用扁平化的组织架构，以前沿技术为核心驱动力，致力于成为“AI+金融”赛道先行者。',
      ],
    },
    {
      name: '智统数合',
