...
已确认但尚未进入腾讯表的会务补充在 `src/data/conference2026-program.ts` 中组合，日程、人物关联和海报统一消费该结果。
2026-09-17 会务补充了 Keynote 开场的“刘军：主办方致辞”，后续腾讯表包含该嘉宾时不会重复添加。
...
生成数据同时公开来源中已确认的报告题目，并按 `时间` 字段展示上午、下午分组。
2026-09-19 会务确认的具体钟点集中维护在 `conference2026.schedule`，时段放在 Session 标题旁，Keynote 逐场时间紧邻报告题目。
自由讨论和两天下午的 Poster 使用无底色的文字行，时间作为次要信息紧随环节名称，Poster 提供海报页入口。
10 月 17 日 10:00-10:20 的独立茶歇不在公开日程中显示，已确认的报告时间保持不变。
10 月 17 日、18 日下午均为 14:00-16:00 分会场报告、16:00-18:30 Rising Stars Poster。
