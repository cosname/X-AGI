...
if (personPortraitFiles.length !== 43 || new Set(personPortraitFiles).size !== 43) {
  fail(
    `2026 people portraits: expected 43 unique portraits (40 workbook, one organizer-supplied, two archived) and six placeholders, `
