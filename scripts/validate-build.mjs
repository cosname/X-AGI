...
if (personPortraitFiles.length !== 40 || new Set(personPortraitFiles).size !== 40) {
  fail(
    `2026 people portraits: expected 40 unique attendee-submitted portraits and six placeholders, `
